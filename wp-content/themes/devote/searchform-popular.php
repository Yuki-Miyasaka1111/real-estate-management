                ...
                <section>
                    <ul class="area-popular">
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="新橋・浜松町・汐留" type="checkbox" name="popular[]">
                                <span>新橋・浜松町・汐留<small>(<?php echo loopPostCountRent ('popular-area', '新橋・浜松町・汐留') + loopPostCountBuy ('popular-area', '新橋・浜松町・汐留'); ?>)</small></span>
                            </label>
                        </li>
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="芝・芝公園" type="checkbox" name="popular[]">
                                <span>芝・芝公園<small>(<?php echo loopPostCountRent ('popular-area', '芝・芝公園') + loopPostCountBuy ('popular-area', '芝・芝公園'); ?>)</small></span>
                            </label>
                        </li>
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="勝どき・月島・佃・晴海" type="checkbox" name="popular[]">
                                <span>勝どき・月島・佃・晴海<small>(<?php echo loopPostCountRent ('popular-area', '勝どき・月島・佃・晴海') + loopPostCountBuy ('popular-area', '勝どき・月島・佃・晴海'); ?>)</small></span>
                            </label>
                        </li>
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="豊洲・東雲・有明・台場" type="checkbox" name="popular[]">
                                <span>豊洲・東雲・有明・台場<small>(<?php echo loopPostCountRent ('popular-area', '豊洲・東雲・有明・台場') + loopPostCountBuy ('popular-area', '豊洲・東雲・有明・台場'); ?>)</small></span>
                            </label>
                        </li>
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="天王洲・大井町・品川シーサイド" type="checkbox" name="popular[]">
                                <span>天王洲・大井町・品川シーサイド<small>(<?php echo loopPostCountRent ('popular-area', '天王洲・大井町・品川シーサイド') + loopPostCountBuy ('popular-area', '天王洲・大井町・品川シーサイド'); ?>)</small></span>
                            </label>
                        </li>
                        <li class="area-popular__item">
                            <label>
                                <input class="disabled" value="芝浦・海岸・港南" type="checkbox" name="popular[]">
                                <span>芝浦・海岸・港南<small>(<?php echo loopPostCountRent ('popular-area', '芝浦・海岸・港南') + loopPostCountBuy ('popular-area', '芝浦・海岸・港南'); ?>)</small></span>
                            </label>
                        </li>
                    </ul>
                    <div class="area-btns">
