...
<form role="searchform" method="get" class="searchform-filterPopular" id="searchform-filterPopular" action="<?php bloginfo('url'); ?>">
    <!-- modalエリア -->
    <div class="modal js-modalArea filterRentPopular">
                    ...
                    <section class="modal-filter__unit">
                        ...
                        <div class="modal-filter__unitDetail">
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="新橋・浜松町・汐留" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('新橋・浜松町・汐留', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>新橋・浜松町・汐留<small>(<?php echo loopPostCountRent ('popular-area', '新橋・浜松町・汐留'); ?>)</small></span>
                            </label>
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="芝・芝公園" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('芝・芝公園', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>芝・芝公園<small>(<?php echo loopPostCountRent ('popular-area', '芝・芝公園'); ?>)</small></span>
                            </label>
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="勝どき・月島・佃・晴海" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('勝どき・月島・佃・晴海', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>勝どき・月島・佃・晴海<small>(<?php echo loopPostCountRent ('popular-area', '勝どき・月島・佃・晴海'); ?>)</small></span>
                            </label>
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="豊洲・東雲・有明・台場" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('豊洲・東雲・有明・台場', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>豊洲・東雲・有明・台場<small>(<?php echo loopPostCountRent ('popular-area', '豊洲・東雲・有明・台場'); ?>)</small></span>
                            </label>
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="天王洲・大井町・品川シーサイド" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('天王洲・大井町・品川シーサイド', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>天王洲・大井町・品川シーサイド<small>(<?php echo loopPostCountRent ('popular-area', '天王洲・大井町・品川シーサイド'); ?>)</small></span>
                            </label>
                            <label class="modal-filter__checkbox modal-filter__checkboxPopular">
                                <input class="disabled" value="芝浦・海岸・港南" type="checkbox" name="rentPopular[]" <?php if(isset($_GET['rentPopular']) && in_array('芝浦・海岸・港南', $_GET['rentPopular'])): ?>checked<?php endif; ?>>
                                <span>芝浦・海岸・港南<small>(<?php echo loopPostCountRent ('popular-area', '芝浦・海岸・港南'); ?>)</small></span>
                            </label>
                        </div>
                    </section>
                </div>
