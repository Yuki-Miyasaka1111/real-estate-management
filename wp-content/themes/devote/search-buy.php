...
$buyDistrict = $_GET['buyDistrict'];
if ($buyDistrict) {
  // 絞り込み条件を追加
  $taxquerysp[] = array(
    'taxonomy' => 'area',
    'terms' => $buyDistrict, //取得したパラメーターが入る
    'field' => 'slug',
...
<main class="buy">
  <div class="search">
    <div class="search-filter">
      ...
      <?php elseif(strstr($url,'buyPopular')==true): ?>
        <?php get_template_part('searchform-filterBuyPopular'); ?>

      <?php elseif(strstr($url,'buyDistrict')==true): ?>
        <?php get_template_part('searchform-filterBuyDistrict'); ?>
    ...
    <div class="results">
        <h1>
            <span class="replace-text">
                <?php if(strstr($url,'buyDistrict')==true): ?>
                    <?php if (count($buyDistrict) > 1): ?>
                        <?php echo $buyDistrict[0]; ?>
                ...
                <?php if(strstr($url,'buyPopular')==true): ?>
