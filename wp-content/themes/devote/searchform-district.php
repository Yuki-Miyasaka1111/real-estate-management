        ...
        <form role="search" method="get" id="searchform" action="<?php bloginfo('url'); ?>">
            <div class="area-container">
                ...
                <section>
                    ...
                    <ul class="area-list">
                        <!-- 港区 -->
                        <?php $term = get_term(3035 , 'area'); $count = $term->count;?>
                        <li class="area-list__item">
                            <label>
                                ...
                                <span><p><?php echo $term->name; //ターム名 ?></p><p class="counts"><?php echo $count ?>件</p></span>
                            </label>
                        </li>

                        <!-- 中央区 -->
                        <?php $term = get_term(3030 , 'area'); $count = $term->count;?>
                        <li class="area-list__item">
                            <label>
                        ...
                        <!-- 品川区 -->
                        <?php $term = get_term(3041 , 'area'); $count = $term->count;?>
                        <li class="area-list__item">
                            <label>
                        ...
                        <!-- 江東区 -->
                        <?php $term = get_term(3708 , 'area'); $count = $term->count;?>
                        <li class="area-list__item">
                            <label>
