					...
					<div class="content-primary">
						...
						<section class="property-primary">
							...
							<dl class="property-details">
								...
								<dt>フリーレント</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'free_rent',true)): // 入力がある場合 ?>
										<?php echo post_custom('free_rent'); ?>ヶ月
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>保険</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'insurance',true)): // 入力がある場合 ?>
										<?php echo post_custom('insurance'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>保証会社</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'guaranty_company',true)): // 入力がある場合 ?>
										<?php echo post_custom('guaranty_company'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>保証金</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'guarantee',true)): // 入力がある場合 ?>
										<?php echo post_custom('guarantee'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>方角</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'direction',true)): // 入力がある場合 ?>
								...
								<dt>賃借種別</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'rent_kinds',true)): // 入力がある場合 ?>
										<?php echo post_custom('rent_kinds'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>入居日</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'timing',true)): // 入力がある場合 ?>
										<?php echo post_custom('timing'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
								...
								<dt>取引態様</dt>
								<dd>
									<?php if(get_post_meta($post->ID, 'mode',true)): // 入力がある場合 ?>
										<?php echo post_custom('mode'); ?>
									<?php else: ?>
									-
									<?php endif; ?>
								</dd>
