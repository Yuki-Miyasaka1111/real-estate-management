...
<form role="searchform" method="get" class="searchform-filterRentDistrict" id="searchform-filterDistrict" action="<?php bloginfo('url'); ?>">
    <!-- modalエリア -->
    <div class="modal js-modalArea filterRentDistrict">
