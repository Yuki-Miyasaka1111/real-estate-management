        ...
        <div class="top-search">
            <div class="top-search__block">
                <div class="search-left">
                    ...
                    <h2 class="search-left__jp">売買・購入物件を探す</h2>
                    <?php
                    $numposts_buy = $wpdb->get_var("SELECT count(*) FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'buy'");
                    ?>
                    <p class="search-left__text"><?php if (0 < $numposts_buy){
                        $numposts_buy = number_format($numposts_buy);
                        echo '掲載物件数<span class="search-left__num">' . $numposts_buy . '</span>件';
                    }
                    ?></p>
                </div>
                <div class="search-right">
                    <p class="search-right__text">条件を指定して検索</p>
                    <button onclick="location.href='/buy-district'"  class="search-right__button">区<br><span class="search-right__smallbutton">から探す</span></button>
                    <button onclick="location.href='/buy-popular'"  class="search-right__button">人気エリア<br><span class="search-right__smallbutton">から探す</span></button>
                </div>
            </div>
        </div>
        ...
        <div class="popularArea">
            ...
            <ul class="popularArea-list">
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=新橋・浜松町・汐留&s=&post_type=buy">
                        <img src="/wp-content/themes/devote/img/platform_bg.jpeg">
                        <p>新橋<br>浜松町<br>汐留</p>
                    </a>
                </li>
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=芝・芝公園&s=&post_type=buy">
                        <img src="">
                        <p>芝<br>芝公園</p>
                    </a>
                </li>
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=勝どき・月島・佃・晴海&s=&post_type=buy">
                        <img src="">
                        <p>勝どき<br>月島<br>佃<br>晴海</p>
                    </a>
                </li>
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=豊洲・東雲・有明・台場&s=&post_type=buy">
                        <img src="">
                        <p>豊洲<br>東雲<br>有明<br>台場</p>
                    </a>
                </li>
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=天王洲・大井町・品川シーサイド&s=&post_type=buy">
                        <img src="">
                        <p>天王洲<br>大井町<br>品川シーサイド</p>
                    </a>
                </li>
                <li class="popularArea-item">
                    <a href="/?buyPopular%5B%5D=芝浦・海岸・港南&s=&post_type=buy">
                        <img src="">
                        <p>芝浦<br>海岸<br>港南</p>
                    </a>
                </li>
